...
- [ ] [Youtube: Research Paper Walkthrough](https://www.youtube.com/playlist?list=PLsAqq9lZFOtWUz1WEoJ3GXw197LD7BxMc)
	...
	- [ ] [BERT4Rec: Sequential Recommendation with Bidirectional Encoder Representations from Transformer](https://www.youtube.com/watch?v=4pYHEzwTa78) `0:10:11`
	...
	- [ ] [Few-Shot Learning (1/3): Basic Concepts](https://www.youtube.com/watch?v=hE7eGew4eeg) `0:18:38`
	...
	- [ ] [Formal Description of Prompting: Systematic Survey of Prompting Methods in NLP (P.1)](https://www.youtube.com/watch?v=K3MasIU25Zw) `0:20:19`
	- [ ] [Language Models and Prompt Engineering: Systematic Survey of Prompting Methods in NLP (P.2)](https://www.youtube.com/watch?v=OsbUfL8w-mo) `0:20:07`
	- [ ] [Multi-Prompt Learning: Systematic Survey of Prompting Methods in NLP (P.3)](https://www.youtube.com/watch?v=iUNDg0etR9U) `0:16:32`
...
- [X] [Youtube: Hugging Face Course Chapter 2](https://www.youtube.com/playlist?list=PLo2EIpI_JMQupmYlTIrUTWD_oV-kYA3Hx)
	- [X] [What happens inside the pipeline function? (PyTorch)](https://www.youtube.com/watch?v=1pedAIvTWXk) `0:04:52`
	- [X] [What happens inside the pipeline function? (TensorFlow)](https://www.youtube.com/watch?v=wVN12smEvqg) `0:05:00`
	- [X] [Instantiate a Transformers model (PyTorch)](https://www.youtube.com/watch?v=AhChOFRegn4) `0:03:20`
	- [X] [Instantiate a Transformers model (TensorFlow)](https://www.youtube.com/watch?v=d3JVgghSOew) `0:03:14`
	- [X] [Tokenizers overview](https://www.youtube.com/watch?v=VFp38yj8h3A) `0:00:56`
	- [X] [Word-based tokenizers](https://www.youtube.com/watch?v=nhJxYji1aho) `0:02:52`
	- [X] [Character-based tokenizers](https://www.youtube.com/watch?v=ssLq_EK2jLE) `0:03:01`
	- [X] [Subword-based tokenizers](https://www.youtube.com/watch?v=zHvTiHr506c) `0:03:28`
...
- [ ] [Article: Convolutional Neural Networks (CNNs / ConvNets)
](https://cs231n.github.io/convolutional-networks/)
- [ ] [Article: Convolutional Neural Networks, Explained](https://towardsdatascience.com/convolutional-neural-networks-explained-9cc5188c4939)
- [ ] [Article: How to Visualize Filters and Feature Maps in Convolutional Neural Networks](https://machinelearningmastery.com/how-to-visualize-filters-and-feature-maps-in-convolutional-neural-networks/)
- [ ] [Youtube: How Convolutional Neural Networks Work, in depth](https://www.youtube.com/watch?v=JB8T_zN7ZC0)
- [X] [Article: Convolutional Neural Networks for Beginners](https://serokell.io/blog/introduction-to-convolutional-neural-networks)
...
- [ ] [Article:Python Design Patterns](https://refactoring.guru/design-patterns)
- [X] [I trained a model. What is next?](https://ternaus.blog/tutorial/2020/08/28/Trained-model-what-is-next.html)
...
- [ ] [Youtube: Hitesh Choudhary | MongoDB](https://www.youtube.com/playlist?list=PLzAGFfNxKFualSih9sm4FCRy9L7o_rVY8)
	...
	- [X] [Create and Read operation in MongoDB](https://www.youtube.com/watch?v=MXIpMcMGRds) `0:16:34`
	- [X] [ObjectID and BSON in mongoDB](https://www.youtube.com/watch?v=TQ4KFPzb6vI) `0:12:49`
	- [X] [Triple A and CRUD operations in mongoDB](https://www.youtube.com/watch?v=MWBQwWXu4jE) `0:07:45`
